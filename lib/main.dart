...
import 'Dashboard-advocate.dart';
import 'flash.dart';
import 'signup.dart';
import 'dashboard.dart';
import 'otp.dart';
import 'regAsLegalServiceProvider.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/otp': (context) => Otp(email: "example@email.com", uname: "exampleUsername"),
...
class _MyHomePageState extends State<MyHomePage> {
 ...
 void validate() {
   Navigator.pushNamed(context, '/regAsLegalServiceProvider');
 }
